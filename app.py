...
timeline_posts = [
    {
        "date": "June 27, 2023",
        "title": "Honor Roll recieved",
        "content": "I received the honor roll for my school, I was very happy to see that my hard work paid off!"
    },
    {
        "date": "March 10, 2025",
    ...
    {
        "date": "May 18, 2025",
        "title": "Minority report by Philip",
        "content": " Set in a future where Precrime uses mutated humans (Precogs) to predict and arrest individuals before they commit murder, the story follows the head of Precrime who becomes a fugitive when the system forecasts he will kill someone."
    },
    {
        "date": "May 27, 2025",
        "title": "Finished zero to one by Peter Thiel",
        "content": " Peter Thiel argues that true innovation comes from creating entirely new things (going from 0 to 1), like monopolies through unique technology, rather than copying existing models (going from 1 to n) or competing in crowded markets."
    },
    {
        "date": "May 30, 2025",
        "title": "Thinking, Fast and Slow by Daniel Kahneman",
        "content": "This seminal work explores the dual systems of human thought—fast, intuitive System 1 and slow, analytical System 2—revealing how pervasive cognitive biases and heuristics often lead to systematic errors in judgment, challenging the notion of human rationality."
    }
